public class SalaryCalculator {
    ...
    public double finalSalary(int daysSkipped, int productsSold) {
        final double FINAL_SALARY = BASE_SALARY * salaryMultiplier(daysSkipped) + bonusForProductsSold(productsSold);
        return FINAL_SALARY > SALARY_CAP ? SALARY_CAP : FINAL_SALARY;
    }
}
